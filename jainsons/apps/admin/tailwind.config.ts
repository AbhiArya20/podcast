...
export default {
  ...
  theme: {
    extend: {
      fontSize: {
        "heading-1": ["2.875rem", { lineHeight: "4.25rem", fontWeight: "500" }],
        "heading-2": ["2.375rem", { lineHeight: "3.5rem", fontWeight: "500" }],
        "heading-3": ["1.75rem", { lineHeight: "2.625rem", fontWeight: "500" }],
        "heading-4": ["1.5rem", { lineHeight: "2.375rem", fontWeight: "500" }],
        "heading-5": ["1.125rem", { lineHeight: "1.75rem", fontWeight: "500" }],
        "heading-6": [
          "0.9375rem",
        ...
        "body-1": ["0.9375rem", { lineHeight: "1.375rem", fontWeight: "400" }],
        "body-2": ["0.8125rem", { lineHeight: "1.25rem", fontWeight: "400" }],
        caption: ["0.8125rem", { lineHeight: "1.125rem", fontWeight: "400" }],
        overline: ["0.75rem", { lineHeight: "0.875rem", fontWeight: "400" }],
        button: ["0.9375rem", { lineHeight: "1.125rem", fontWeight: "500" }],
      },
      colors: {
        background: "hsl(var(--background))",
        "on-background": "hsl(var(--on-background))",
        foreground: "hsl(var(--foreground))",
        "on-foreground": "hsl(var(--on-foreground))",
        card: {
