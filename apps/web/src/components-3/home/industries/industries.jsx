...
import { Virtual, Keyboard, Navigation, Pagination, Parallax, A11y, Autoplay, EffectCoverflow, EffectCards, Mousewheel } from "swiper/modules";
	...
	return (
		<div className={styles.industriesWrapper}>
			<div className={styles.industriesHeadingWrapper}>
				<div className={styles.industriesHeadingTitle}>Connecting Teams Across Industries and Geographies for Enhanced Collaboration.</div>
				<div className={styles.industriesHeadingSubTitle}>Our online meeting software is flexible enough to meet growing video conferencing needs across industries. Connect, collaborate, and empower your business to stand out in your industry with our secure web meeting software.</div>
			</div>
