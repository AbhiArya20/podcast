...
const StepOTP = () => {
  ...
  const { otp, setOtp, error, isLoading, update, handleEnterClickEvent } =
    useOTPStep();
  ...
  return (
    <FormWrapper isLoading={isLoading}>
      <FormLeft
        ...
        subTitle={email}
        description="An OTP has been sent to your email. Please check your inbox, and if you don't see it, Don’t forget to check your spam folder"
      />
      <FormRight
