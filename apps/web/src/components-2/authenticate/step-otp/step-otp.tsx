...
import { sendOtp, verifyOtp } from "@/https";
...
const StepOTP = ({ onNext }) => {
  ...
  const validateFunc = () => {
    ...
    throw new CustomError({
      message: "Looks like the OTP is incorrect.",
      description: "Please check your email for correct OTP",
    });
  };
  const { error, loading, update } = useUpdate(submit, {
    validateFunc,
    onSuccess,
  });
  ...
  const {
    ...
    data: resendData,
    update: resendOTPupdate,
  } = useUpdate(resendOtp, { onSuccess: onSuccessResend });
          ...
          <div className={styles.errorContent}>
            ...
            <div className={styles.errorDetails}>
              <div className={styles.SignIn}>
                ...
                <div className={styles.descriptionContainer}>
                  <p className={styles.errorDescription}>
                    ...
                    Please check your inbox (and spam folder) and enter the OTP
                    to continue
                  </p>
                </div>
              </div>
              ...
              <form
                ...
                onKeyDown={handleEnterClickEvent}
              >
                {error && (
