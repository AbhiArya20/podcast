              ...
              <div className={styles.SignIn}>
                ...
                <div className={styles.descriptionContainer}>
                  <p className={styles.errorDescription}>
                    By Sign-In or Sign-Up, you’re agreeing to our{" "}
              ...
              >
                ...
                <div className={styles.textInputWrapper}>
                  <TextInput
                    ...
                    placeholder="abhyarya.2.0@gmail.com"
                  />
                </div>
                <div className={styles.buttonWrapper}>
                  <Button
                    onClick={fUpdate}
                    className={styles.facebookButtonExtention}
                  >
                    <FaFacebookF className={styles.actionIcon} />
                  </Button>
                  <Button
                    onClick={gUpdate}
                    className={styles.googleButtonExtention}
                  >
