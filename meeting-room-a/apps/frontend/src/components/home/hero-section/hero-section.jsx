...
import { Blur } from "../../shared/blur/blur";
			...
			<section className={styles.heroSection}>
				...
				<div className={styles.heroContentWrapper}>
					<div className={styles.heroCard}>
						<HeroCardLeft activeIndex={activeIndex} setActiveIndex={changeSlider} />
						<HeroCardRight activeIndex={activeIndex} setActiveIndex={setActiveIndex} ref={swiperRef} />
					</div>
				</div>
			</section>
		</>
...
const HeroCardLeft = ({ activeIndex, setActiveIndex }) => {
	...
	const onJoinClick = () => navigate("/authenticate");
	return (
				...
				<div className={styles.heroDetailsWrapper}>
					<p className={styles.heroMessage}>
						...
						<span className={styles.heroSectionMessageHighLightWrapper}>
							<span className={`${styles.heroSectionMessageHighLight} ${activeIndex === 0 && styles.heroSectionMessageHighLightHover}`} onMouseEnter={() => setActiveIndex(0)}>
								Video
								<span className={styles.heroSectionMessageHighLightIcon}>
									<MdVideoCameraFront />
								</span>
							</span>
							<span className={`${styles.heroSectionMessageHighLight} ${activeIndex === 1 && styles.heroSectionMessageHighLightHover}`} onMouseEnter={() => setActiveIndex(1)}>
								Chat
								<span className={styles.heroSectionMessageHighLightIcon}>
									<MdChat />
								</span>
							...
							<span className={`${styles.heroSectionMessageHighLight} ${activeIndex === 2 && styles.heroSectionMessageHighLightHover}`} onMouseEnter={() => setActiveIndex(2)}>
								Whiteboarding
								<span className={styles.heroSectionMessageHighLightIcon}>
									<BiSolidChalkboard />
								</span>
					...
					<div className={styles.heroDescriptionWrapper}>
						<p className={styles.heroDescription}>Seamlessly connect with high-quality video, real-time chat, and easy presentation tools anytime, anywhere. Transform your teamwork and drive projects forward effortlessly!</p>
					</div>
		...
		<div className={styles.heroCardRight}>
			<Swiper
				...
				<SwiperSlide className={styles.heroSectionRightSwipperSlide}>
					<img src="/assets/Events.avif" alt={"Meetings"} className={styles.featureCardImg} />
				</SwiperSlide>
				<SwiperSlide className={styles.heroSectionRightSwipperSlide}>
					<img src="/assets/Meetings.avif" alt={"Meetings"} className={styles.featureCardImg} />
				</SwiperSlide>
				<SwiperSlide className={styles.heroSectionRightSwipperSlide}>
					<img src="/assets/Messaging.avif" alt={"Meetings"} className={styles.featureCardImg} />
				</SwiperSlide>
			</Swiper>
