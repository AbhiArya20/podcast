...
// import { EMPLOYER_SERVICE_API_URL } from '../envConfig';
// import { onFullFill, onRejected } from './interceptor/interceptor-functions';

// const api = axios.create({
//   baseURL: EMPLOYER_SERVICE_API_URL,
//   withCredentials: true
// });

// export const getEmployerPercentCount = async () => await api.get('/employers/percent-count');
