...
// export default function UpdateEvent({ event, onUpdate }) {
//   const customOptions = {
//     month: 'short',
//     day: 'numeric',
//     year: 'numeric',
...
//   const [eventAmount, setEventAmount] = useState(event.eventAmount);
//   const [discount, setDiscount] = useState(event.discount);
//   const [discountEndDate, setDiscountEndDate] = useState(event.discountEndDate);
//   const [showDiscountEndDate, setShowDiscountEndDate] = useState(dayjs(event.discountEndDate).toLocaleString('en-US', customOptions));
//   const [websiteUrl, setWebsiteUrl] = useState(event.websiteUrl);
//   const [startDate, setStartDate] = useState(event.startDate);
//   const [showStartDate, setShowStartDate] = useState(dayjs(event.startDate).toLocaleString('en-US', customOptions));
//   const [endDate, setEndDate] = useState(event.endDate);
//   const [showEndDate, setShowEndDate] = useState(dayjs(event.endDate).toLocaleString('en-US', customOptions));
...
//           <CustomButton btnText='Update' handleSubmit={handleSubmit} loading={loading} className={`mt-4 `} />
//         </form>
//       </div>
//     </div>
//   );
