...
// import KycList from '../src/components/custom-components/CustomTable';
...
// const tabs = ['Total KYC', 'Underprocess', 'Approved', 'Not Approved', 'Hold', 'Not Submitted'];
...
//   console.log(search, selectedTab, seletedRadioBtn);
...
//           <KycList column={columns} data={filteredCountries} loading={loading} />
//         </div>
//       </div>
//     </div>
//   );
