...
//               <div className={`active flex w-auto absolute items-center top-0 right-0 p-1 text-xs ${jobseekerData.isActive ? 'text-[#7451f8] bg-[#7551f818]' : 'text-[#808080] bg-[#9f9f9f18]'}`}>
//                 <span>{jobseekerData.isActive ? 'Active' : 'Disabled'}</span>
//                 <div className={`Mark rounded-md ml-1 w-2 h-2 ${jobseekerData.isActive ? 'bg-[#7451f8]' : 'bg-[#9f9f9f]'}`}></div>
//               </div>

//               <h1 className='title w-full text-base mb-1 text-[#d3d3d3] '>Information</h1>
//               <div className='flex gap-5'>
//                 <img src={jobseekerData.profilePicLink} alt='' className='w-24 h-24 rounded-[50%] object-cover' />
...
//                       <span className='ItemValue'>{jobseekerData.email}</span>
//                     </div>
//                     <div className={`verified rounded-md p-[1.5px] ${jobseekerData.isEmailVerified ? 'bg-[#abf8c178] text-green-600' : 'bg-[#ffbbbb] text-red-600'}`}>
//                       {jobseekerData.isEmailVerified ? 'verified' : 'not verified'}
//                     </div>
//                   </div>
...
//                       <span className='ItemValue'>{jobseekerData.DOB}</span>
//                     </div>
//                   </div>
...
//                       <span className='ItemValue'>{jobseekerData.gender}</span>
//                     </div>
//                   </div>
...
//                       <span className='ItemValue'>{jobseekerData.designation}</span>
//                     </div>
//                   </div>
...
//                       <span className='ItemValue'>{jobseekerData.currentOrganization}</span>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                 <img src={jobseekerData.aadharFrontImage} alt='' className='w-full' />
//               </div>
...
//                   <ThreeSixtyIcon />
//                 </div>
//                 <img src={jobseekerData.aadharBackImage} alt='' className='employerAdhaar' />
//               </div>
//             </div>
//           </div>
